...
{
	pez1_ = new Particle({ pos1.x,pos1.y,pos1.z }, { 0,0,0 }, { 0,0,0 }, 0.99, -1, { 0.7,0.1,0.8,1 }, 1, 4, -1);
	...
	generator_ = new GaussianParticleGenerator({ pos1.x,pos1.y - 3,pos1.z+1 }, { 1,1,1 }, { 0,0,0 }, { 0.8,0.8,0.8 }, {0.5,0.5,0.5},
